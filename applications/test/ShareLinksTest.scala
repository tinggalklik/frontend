    ...
    whenReady(response) { item: ItemResponse =>
      ...
      item.content.map { apiContent =>
        ...
        elementShares.map(_.href) should be(List(
          ...
          "http://www.pinterest.com/pin/create/button/?description=2014%20Wildlife%20photographer%20of%20the%20Year&url=https%3A%2F%2Fwww.theguardian.com%2Fenvironment%2Fgallery%2F2014%2Foct%2F22%2F2014-wildlife-photographer-of-the-year%3Fpage%3Dwith%3A2%232&media="
        ))
      }
    }
  }
